...
struct conn_update_param_t {    //连接更新参数
    u16 interval_min;  //(unit:0.625ms) //最小间隔
    u16 interval_max;  //(unit:0.625ms) //最大间隔
    u16 latency;       //(unit: interval)   //延迟
    u16 timeout;       //(unit:10ms)        //超时
};
...
/**********************************************************************************
   @function 注册passkey 输入回调，passkey=密钥
   @param [in]
   @return
 *********************************************************************************/
...
/**********************************************************************************
   @function 配置adv filter policy广播过滤政策, default 0
...
/**********************************************************************************
   ...
   @function 配置广播 扫描应答数据Scan Response Data内容，!!!注意：设置的时候必现在广播关闭的状态下
...
/**********************************************************************************
   ...
   @param [in]mtu  对方mtu payload的大小 payload：有效负载
   @param [in]
   @param [in]
   @param [in]
   @return    see ble_cmd_ret_e
...
/**********************************************************************************
   ...
   @param [out] remain_size_ptr   输出可写入长度值，remain：保持
   @return    see ble_cmd_ret_e
 *********************************************************************************/
...
/**********************************************************************************
   ...
   @function ble5.0 配置 respond 应答数据包
   @param [in]data  数据包内容
   @param [in]data_len 数据包长度
   @param [in]
   @param [in]
...
/**********************************************************************************
   ...
   @function   忽略进入latency 延迟的次数。!!!注意：让设备不进入latency模式，加快响应速度，但会耗电
   @param [in] con_handle 连接 con_handle,range：>0，skip：跳过
...
/**********************************************************************************
   @function 配置扫描过滤策略scan filter policy,default 0
   @param [in] type   Range: 0x00 to 0x03
   @return  see ble_cmd_ret_e
...
/**********************************************************************************
   @function 配置创建过滤策略creat filter policy,default 0
   @param [in] type   Range: 0x00 to 0x03
   @return  see ble_cmd_ret_e
...
/**********************************************************************************
   ...
   @param [in] enable  是否允许循环覆盖记录  1 or 0,默认1，pair：配对
   @param [in]
   @param [in]
   @param [in]
   @return    true or false
...
/**********************************************************************************
   @function   绑定已配对的指定设备,清除其他配对设备remote：远程 bonding：绑定
...
/**********************************************************************************
   ...
   @function   ble 从机 检测连接地址是否在已配对表中，exist：存在
   @param [in] conn_addr_type   对方地址类型range: 0~1
   @param [in]
   @param [in]
   @return    true or false
...
/**********************************************************************************
   @function ble slave: att server 连接后主动发起请求MTU交换流程，exchange：交换
   @param [in] handle  连接 con_handle,range：>0
   @param [in]
   @param [in]
   @return
...
/**********************************************************************************
   @function ble slave: att server 使能流控功能，flow：流控
   @param [in] handle  连接 con_handle,range：>0
   @param [in] enable: 1 or 0
   @param [in]
   @return
