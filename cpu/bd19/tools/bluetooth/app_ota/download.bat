...
..\..\isd_download.exe -tonorflash -dev bd19 -boot 0x2000 -div8 -wait 300 -uboot uboot.boot -app app.bin cfg_tool.bin  -res config.dat p11_code.bin -uboot_compress -format all -key 193-AC690X-B718.key
